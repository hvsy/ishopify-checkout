...
export const Policy: FC<PolicyProps> = () => {
    ...
    return <div className="page-policies max-h-[calc(70vh-99px)] pb-4 overflow-y-auto text-[#545454] text-sm leading-relaxed">
        ...
        <h2>Contact</h2>
        <p>Should you have any questions about our privacy practices or this Privacy Policy, or if you would like to exercise any of the rights available to you, please call  or email us at {contactEmail} or contact us at 125號 Tai Nan Street, Mong Kok, KL, HK For the purpose of applicable data protection laws, we are the data controller of your personal information. </p>
    </div>;
};
